...
#scrollWidget=pg.console.ConsoleWidget()
...
#heat_curve=wavePlotWidget.plot([], pen=(0,255,0), name='output')
d3.addWidget(wavePlotWidget)
impedancePlotWidget = pg.PlotWidget(title="Impedance")
...
#sens_curve=wavePlotWidget.plot([], pen=(255,0,0), symbol='o', name='sense')
heat_curve=wavePlotWidget.plot([], pen=None, symbolBrush=(0,255,0), symbol='o', name='output')
R_curve=impedancePlotWidget.plot([], pen=(255,255,0), name='R')
C_curve=impedancePlotWidget.plot([], pen=(255,0,255), name='C')
